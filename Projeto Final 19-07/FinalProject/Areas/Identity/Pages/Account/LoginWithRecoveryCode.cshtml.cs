...
namespace FinalProject.Areas.Identity.Pages.Account
{
    public class LoginWithRecoveryCodeModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("Usuário com ID '{UserId}' logou com um código de recuperação", user.Id);
            ...
            {
                _logger.LogWarning("Usuário com ID '{UserId}' informou um código de recuperação inválido", user.Id);
